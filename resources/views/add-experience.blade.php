...
<div class="flex mt-8 justify-between">
    <h2 class="text-2xl font-bold">Create New Experience</h2>

    <div class="flex gap-3">
        <a href="{{ route('experience') }}"
            class="px-2.5 py-2 border hover:bg-gray-200 hover:font-medium text-sm rounded flex items-center gap-2"
...
<div class="mt-8">
    ...
    <select id="attribute"
        ...
        <option selected>Select Experience Attribute</option>
    </select>
</div>


<div class="mt-8">
    <label for="attribute" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Category</label>
    <select id="attribute"
        class="mt-5 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
...
<div class="mt-8">
    <label for="attribute" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Display</label>
...
<div class="mt-8">
    <label for="attribute" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Title</label>
...
<div class="mt-8">
    <label for="attribute" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Date</label>
...
<div class="mt-8">
    <label for="attribute" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Description</label>
    <form>
        <div
            ...
            <div class="px-4 py-2 bg-white rounded-b-lg dark:bg-gray-800">
                ...
                <textarea id="editor" rows="8"
                    ...
                    placeholder="Insert experience description" required></textarea>
            </div>
        </div>
        <div class="flex justify-between">
            <a href="{{ route('experience') }}"
                class="px-2.5 py-2 text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 text-sm font-medium rounded"
                aria-current="page">Kembali</a>
            <button type="submit"
                class="inline-flex items-center px-2.5 py-2 text-sm font-medium text-center text-white bg-blue-500 rounded focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-900 hover:bg-blue-800">
                Simpan
            </button>
        </div>
    </form>
