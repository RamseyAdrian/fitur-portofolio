...
<div class="mt-8" id="input_field">
    <div class="">
        ...
        <select id="countries"
            ...
            <option value="US">Kerja Praktik</option>
            <option value="CA">Magang</option>
            <option value="CA">Asisten/Tutor</option>
            <option value="CA">Kerja Sampingan</option>
            <option value="CA">Profesi Sertifikasi</option>
            <option value="CA">Kerja Sekarang</option>
        </select>
    </div>
    ...
    <div class="mt-5">
        ...
        <div id="date-range-picker" date-rangepicker class="mt-5 flex items-center">
